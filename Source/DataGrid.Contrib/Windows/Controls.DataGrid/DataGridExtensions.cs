...
namespace ActiproSoftware.Windows.Controls.DataGrid {
	...
	public static class DataGridExtensions {
		...
		/// <summary>
		/// Returns the <c>DataGridRow</c> at the specified index, or <c>null</c> if the row is not available.
		/// </summary>
		...
		public static DataGridRow? GetRow(this DataGridControl dataGrid, int index) {
			...
			if ((row is null) && dataGrid.EnableRowVirtualization && dataGrid.IsLoaded && dataGrid.IsVisible) {
		...
		/// <summary>
		/// Returns the <c>DataGridRow</c> for the specified item, or <c>null</c> if the row is not available.
		/// </summary>
		/// <param name="dataGrid">The <c>DataGrid</c>.</param>
