...
namespace ActiproSoftware.Windows.Controls.Editors.Interop.DataGrid {
	...
	public class DataGridByteColumn : DataGridPartEditBoxColumnBase<Byte?> {
		...
		public static readonly DependencyProperty DefaultValueProperty = DependencyProperty.Register("DefaultValue", typeof(Byte), typeof(DataGridByteColumn), new PropertyMetadata((Byte)0, NotifyPropertyChangeForRefreshContent));
		...
		public static readonly DependencyProperty FormatProperty = DependencyProperty.Register("Format", typeof(string), typeof(DataGridByteColumn), new PropertyMetadata("D", NotifyPropertyChangeForRefreshContent));
		...
		public static readonly DependencyProperty LargeChangeProperty = DependencyProperty.Register("LargeChange", typeof(Byte), typeof(DataGridByteColumn), new PropertyMetadata((Byte)5, NotifyPropertyChangeForRefreshContent));
		...
		public static readonly DependencyProperty MaximumProperty = DependencyProperty.Register("Maximum", typeof(Byte), typeof(DataGridByteColumn), new PropertyMetadata(Byte.MaxValue, NotifyPropertyChangeForRefreshContent));
		...
		public static readonly DependencyProperty MinimumProperty = DependencyProperty.Register("Minimum", typeof(Byte), typeof(DataGridByteColumn), new PropertyMetadata(Byte.MinValue, NotifyPropertyChangeForRefreshContent));
		...
		public static readonly DependencyProperty PickerKindProperty = DependencyProperty.Register("PickerKind", typeof(ByteEditBoxPickerKind), typeof(DataGridByteColumn), new PropertyMetadata(ByteEditBoxPickerKind.Default, NotifyPropertyChangeForRefreshContent));
		...
		public static readonly DependencyProperty SmallChangeProperty = DependencyProperty.Register("SmallChange", typeof(Byte), typeof(DataGridByteColumn), new PropertyMetadata((Byte)1, NotifyPropertyChangeForRefreshContent));
