...
namespace ActiproSoftware.Windows.Controls.Editors.Interop.DataGrid {
	...
	public class DataGridVectorColumn : DataGridPartEditBoxColumnBase<Vector?> {
		...
		public static readonly DependencyProperty DefaultValueProperty = DependencyProperty.Register("DefaultValue", typeof(Vector), typeof(DataGridVectorColumn), new PropertyMetadata(new Vector(0, 0), NotifyPropertyChangeForRefreshContent));
		...
		public static readonly DependencyProperty FormatProperty = DependencyProperty.Register("Format", typeof(string), typeof(DataGridVectorColumn), new PropertyMetadata("G", NotifyPropertyChangeForRefreshContent));
		...
		public static readonly DependencyProperty IsNaNAllowedProperty = DependencyProperty.Register("IsNaNAllowed", typeof(bool), typeof(DataGridVectorColumn), new PropertyMetadata(false, NotifyPropertyChangeForRefreshContent));
		...
		public static readonly DependencyProperty IsNegativeInfinityAllowedProperty = DependencyProperty.Register("IsNegativeInfinityAllowed", typeof(bool), typeof(DataGridVectorColumn), new PropertyMetadata(false, NotifyPropertyChangeForRefreshContent));
		...
		public static readonly DependencyProperty IsPositiveInfinityAllowedProperty = DependencyProperty.Register("IsPositiveInfinityAllowed", typeof(bool), typeof(DataGridVectorColumn), new PropertyMetadata(false, NotifyPropertyChangeForRefreshContent));
		...
		public static readonly DependencyProperty LargeChangeProperty = DependencyProperty.Register("LargeChange", typeof(Vector), typeof(DataGridVectorColumn), new PropertyMetadata(new Vector(5, 5), NotifyPropertyChangeForRefreshContent));
		...
		public static readonly DependencyProperty MaximumProperty = DependencyProperty.Register("Maximum", typeof(Vector), typeof(DataGridVectorColumn), new PropertyMetadata(new Vector(100000, 100000), NotifyPropertyChangeForRefreshContent));
		...
		public static readonly DependencyProperty MinimumProperty = DependencyProperty.Register("Minimum", typeof(Vector), typeof(DataGridVectorColumn), new PropertyMetadata(new Vector(-100000, -100000), NotifyPropertyChangeForRefreshContent));
		...
		public static readonly DependencyProperty RoundingDecimalPlaceProperty = DependencyProperty.Register("RoundingDecimalPlace", typeof(int?), typeof(DataGridVectorColumn), new PropertyMetadata(8, NotifyPropertyChangeForRefreshContent));
		...
		public static readonly DependencyProperty SmallChangeProperty = DependencyProperty.Register("SmallChange", typeof(Vector), typeof(DataGridVectorColumn), new PropertyMetadata(new Vector(1, 1), NotifyPropertyChangeForRefreshContent));
		...
		protected override void ApplyStandardValues(FrameworkElement targetElement) {
			...
			if (targetElement is VectorEditBox) {
				...
				this.ApplyValue(RoundingDecimalPlaceProperty, targetElement, VectorEditBox.RoundingDecimalPlaceProperty);
