...
namespace ActiproSoftware.Windows.Controls.Editors.Interop.DataGrid {
	...
	public class DataGridPointColumn : DataGridPartEditBoxColumnBase<Point?> {
		...
		public static readonly DependencyProperty DefaultValueProperty = DependencyProperty.Register("DefaultValue", typeof(Point), typeof(DataGridPointColumn), new PropertyMetadata(new Point(0, 0)));
		...
		public static readonly DependencyProperty FormatProperty = DependencyProperty.Register("Format", typeof(string), typeof(DataGridPointColumn), new PropertyMetadata("G"));
		...
		public static readonly DependencyProperty IsNaNAllowedProperty = DependencyProperty.Register("IsNaNAllowed", typeof(bool), typeof(DataGridPointColumn), new PropertyMetadata(false));
		...
		public static readonly DependencyProperty IsNegativeInfinityAllowedProperty = DependencyProperty.Register("IsNegativeInfinityAllowed", typeof(bool), typeof(DataGridPointColumn), new PropertyMetadata(false));
		...
		public static readonly DependencyProperty IsPositiveInfinityAllowedProperty = DependencyProperty.Register("IsPositiveInfinityAllowed", typeof(bool), typeof(DataGridPointColumn), new PropertyMetadata(false));
		...
		public static readonly DependencyProperty LargeChangeProperty = DependencyProperty.Register("LargeChange", typeof(Point), typeof(DataGridPointColumn), new PropertyMetadata(new Point(5, 5)));
		...
		public static readonly DependencyProperty MaximumProperty = DependencyProperty.Register("Maximum", typeof(Point), typeof(DataGridPointColumn), new PropertyMetadata(new Point(100000, 100000)));
		...
		public static readonly DependencyProperty MinimumProperty = DependencyProperty.Register("Minimum", typeof(Point), typeof(DataGridPointColumn), new PropertyMetadata(new Point(-100000, -100000)));
		...
		public static readonly DependencyProperty RoundingDecimalPlaceProperty = DependencyProperty.Register("RoundingDecimalPlace", typeof(int?), typeof(DataGridPointColumn), new PropertyMetadata(8));
		...
		public static readonly DependencyProperty SmallChangeProperty = DependencyProperty.Register("SmallChange", typeof(Point), typeof(DataGridPointColumn), new PropertyMetadata(new Point(1, 1)));
