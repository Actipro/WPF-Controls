...
namespace ActiproSoftware.Windows.Controls.Editors.Interop.DataGrid {
	...
	public class DataGridRectColumn : DataGridPartEditBoxColumnBase<Rect?> {
		...
		public static readonly DependencyProperty DefaultValueProperty = DependencyProperty.Register("DefaultValue", typeof(Rect), typeof(DataGridRectColumn), new PropertyMetadata(new Rect(0, 0, 0, 0), NotifyPropertyChangeForRefreshContent));
		...
		public static readonly DependencyProperty FormatProperty = DependencyProperty.Register("Format", typeof(string), typeof(DataGridRectColumn), new PropertyMetadata("G", NotifyPropertyChangeForRefreshContent));
		...
		public static readonly DependencyProperty IsNaNAllowedProperty = DependencyProperty.Register("IsNaNAllowed", typeof(bool), typeof(DataGridRectColumn), new PropertyMetadata(false, NotifyPropertyChangeForRefreshContent));
		...
		public static readonly DependencyProperty IsNegativeInfinityAllowedProperty = DependencyProperty.Register("IsNegativeInfinityAllowed", typeof(bool), typeof(DataGridRectColumn), new PropertyMetadata(false, NotifyPropertyChangeForRefreshContent));
		...
		public static readonly DependencyProperty IsPositiveInfinityAllowedProperty = DependencyProperty.Register("IsPositiveInfinityAllowed", typeof(bool), typeof(DataGridRectColumn), new PropertyMetadata(false, NotifyPropertyChangeForRefreshContent));
		...
		public static readonly DependencyProperty LargeChangeProperty = DependencyProperty.Register("LargeChange", typeof(Rect), typeof(DataGridRectColumn), new PropertyMetadata(new Rect(5, 5, 5, 5), NotifyPropertyChangeForRefreshContent));
		...
		public static readonly DependencyProperty MaximumProperty = DependencyProperty.Register("Maximum", typeof(Rect), typeof(DataGridRectColumn), new PropertyMetadata(new Rect(100000, 100000, 100000, 100000), NotifyPropertyChangeForRefreshContent));
		...
		public static readonly DependencyProperty MinimumProperty = DependencyProperty.Register("Minimum", typeof(Rect), typeof(DataGridRectColumn), new PropertyMetadata(new Rect(-100000, -100000, 0, 0), NotifyPropertyChangeForRefreshContent));
		...
		public static readonly DependencyProperty RoundingDecimalPlaceProperty = DependencyProperty.Register("RoundingDecimalPlace", typeof(int?), typeof(DataGridRectColumn), new PropertyMetadata(8, NotifyPropertyChangeForRefreshContent));
		...
		public static readonly DependencyProperty SmallChangeProperty = DependencyProperty.Register("SmallChange", typeof(Rect), typeof(DataGridRectColumn), new PropertyMetadata(new Rect(1, 1, 1, 1), NotifyPropertyChangeForRefreshContent));
		...
		/// <summary>
		/// Initializes an instance of the <see cref="DataGridRectColumn"/> class.
		/// </summary>
		...
		protected override void ApplyStandardValues(FrameworkElement targetElement) {
			...
			if (targetElement is RectEditBox) {
				this.ApplyValue(DefaultValueProperty, targetElement, RectEditBox.DefaultValueProperty);
				this.ApplyValue(FormatProperty, targetElement, RectEditBox.FormatProperty);
				this.ApplyValue(IsNaNAllowedProperty, targetElement, RectEditBox.IsNaNAllowedProperty);
				this.ApplyValue(IsNegativeInfinityAllowedProperty, targetElement, RectEditBox.IsNegativeInfinityAllowedProperty);
				this.ApplyValue(IsPositiveInfinityAllowedProperty, targetElement, RectEditBox.IsPositiveInfinityAllowedProperty);
				this.ApplyValue(LargeChangeProperty, targetElement, RectEditBox.LargeChangeProperty);
				this.ApplyValue(MaximumProperty, targetElement, RectEditBox.MaximumProperty);
				this.ApplyValue(MinimumProperty, targetElement, RectEditBox.MinimumProperty);
				this.ApplyValue(RoundingDecimalPlaceProperty, targetElement, RectEditBox.RoundingDecimalPlaceProperty);
				this.ApplyValue(SmallChangeProperty, targetElement, RectEditBox.SmallChangeProperty);
			}
		}
		...
		public Rect DefaultValue {
			get {
				return (Rect)this.GetValue(DefaultValueProperty);
			}
			set {
		...
		public Rect LargeChange {
			get {
				return (Rect)this.GetValue(LargeChangeProperty);
			}
			set {
		...
		public Rect Maximum {
			get {
				return (Rect)this.GetValue(MaximumProperty);
			}
			set {
		...
		public Rect Minimum {
			get {
				return (Rect)this.GetValue(MinimumProperty);
			}
			set {
		...
		public Rect SmallChange {
			get {
				return (Rect)this.GetValue(SmallChangeProperty);
			}
			set {
