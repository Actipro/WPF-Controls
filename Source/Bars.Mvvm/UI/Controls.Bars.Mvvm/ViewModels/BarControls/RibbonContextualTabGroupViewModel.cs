...
public class RibbonContextualTabGroupViewModel : BarKeyedObjectViewModelBase {
	...
	/// <summary>
	/// Initializes an instance of the class with the specified key.  The label is auto-generated.
	/// </summary>
	...
	/// <summary>
	/// Initializes an instance of the class with the specified key and label.
	/// </summary>
	/// <param name="key">A string that uniquely identifies the control.</param>
