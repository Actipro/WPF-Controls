...
public class TextStyleBarGalleryItemViewModel : BarGalleryItemViewModel<TextStyle> {
	...
	/// <summary>
	/// Initializes an instance of the class with a default text style and category.
	/// </summary>
	public TextStyleBarGalleryItemViewModel()  // Parameterless constructor required for XAML support
		: this(value: null, DefaultCategory) { }

	/// <summary>
	/// Initializes an instance of the class with the specified text style and default category.
	/// </summary>
	...
	/// <summary>
	/// Initializes an instance of the class with the specified text style and category.
	/// </summary>
	/// <param name="value">The text style.</param>
	...
	/// <summary>
	/// Initializes an instance of the class with the specified text style, category, and label.
	/// </summary>
	/// <param name="value">The text style.</param>
	/// <param name="category">The item's category, or <c>null</c> if categorization is not supported.</param>
	...
	public static string? DefaultCategory
		=> SR.GetString(SRName.UIGalleryItemCategoryTextStylesText);
