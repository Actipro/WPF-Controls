...
public class FontSizeBarGalleryItemViewModel : BarGalleryItemViewModel<double> {
	...
	/// <summary>
	/// Initializes an instance of the class with a default font size.
	/// </summary>
	public FontSizeBarGalleryItemViewModel()  // Parameterless constructor required for XAML support
		: this(DefaultFontSize) { }

	/// <summary>
	/// Initializes an instance of the class with the specified size and a default category.
	/// </summary>
	...
	/// <summary>
	/// Initializes an instance of the class with the specified size and category.
	/// </summary>
	/// <param name="value">The font size.</param>
	...
	/// <summary>
	/// Initializes an instance of the class with the specified size, category, and label.
	/// </summary>
	/// <param name="value">The font size.</param>
	/// <param name="category">The item's category, or <c>null</c> if categorization is not supported.</param>
	...
	public static string? DefaultCategory
		=> SR.GetString(SRName.UIGalleryItemCategoryFontSizesText);
	...
	/// <remarks>
	/// The value must be <c>1.0</c> or greater.
	/// </remarks>
