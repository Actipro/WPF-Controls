...
public class TextBarGalleryItemViewModel : BarGalleryItemViewModel<string> {
	...
	/// <summary>
	/// Initializes an instance of the class with the specified text as the value and label.
	/// </summary>
	...
	/// <summary>
	/// Initializes an instance of the class with the specified text and category.
	/// </summary>
	/// <param name="text">The item's value and label.</param>
