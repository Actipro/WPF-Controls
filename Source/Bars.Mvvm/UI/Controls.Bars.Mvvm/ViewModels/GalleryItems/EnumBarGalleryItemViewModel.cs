...
namespace ActiproSoftware.Windows.Controls.Bars.Mvvm {
	...
	public class EnumBarGalleryItemViewModel<TEnum> : BarGalleryItemViewModel<TEnum>
		...
		/// <summary>
		/// Throws an exception if <see cref="TEnum"/> is not an enumeration since generic type constraints are not specific enough.
		/// </summary>
		/// <param name="enumType">The type to examine.</param>
		/// <exception cref="ArgumentException">Thrown if <see cref="TEnum"/> is not an enumeration.</exception>
