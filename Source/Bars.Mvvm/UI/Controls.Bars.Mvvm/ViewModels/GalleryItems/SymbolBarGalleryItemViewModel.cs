...
public class SymbolBarGalleryItemViewModel : BarGalleryItemViewModel<string> {
	...
	/// <summary>
	/// Initializes an instance of the class with a default category.
	/// </summary>
	...
	/// <summary>
	/// Initializes an instance of the class with the specified symbol and a default category.
	/// </summary>
	...
	/// <summary>
	/// Initializes an instance of the class with the specified symbol and category.
	/// </summary>
	/// <param name="value">The string symbol.</param>
	...
	/// <summary>
	/// Initializes an instance of the class with the specified symbol, category, and label.
	/// </summary>
	/// <param name="value">The string symbol.</param>
	/// <param name="category">The item's category, or <c>null</c> if categorization is not supported.</param>
	...
	public static string? DefaultCategory
		=> SR.GetString(SRName.UIGalleryItemCategorySymbols);
