...
public class FontFamilyBarGalleryItemViewModel : BarGalleryItemViewModel<string> {
	...
	private static int[]? _knownFontWeights;
	...
	/// <summary>
	/// Initializes an instance of the class with a default font family name and category.
	/// </summary>
	public FontFamilyBarGalleryItemViewModel()  // Parameterless constructor required for XAML support
		: this(DefaultFontFamilyName) { }

	/// <summary>
	/// Initializes an instance of the class with the specified name and a default category.
	/// </summary>
	...
	/// <summary>
	/// Initializes an instance of the class with the specified name and category.
	/// </summary>
	/// <param name="value">The font family name.</param>
	...
	/// <summary>
	/// Initializes an instance of the class with the specified name, category, and label.
	/// </summary>
	/// <param name="value">The font family name.</param>
	/// <param name="category">The item's category, or <c>null</c> if categorization is not supported.</param>
	...
	private static bool IsKnownFontWeight(FontWeight fontWeight) {
		...
		return _knownFontWeights.Contains(fontWeight.ToOpenTypeWeight());
	}
	...
	public static string? DefaultCategory
		=> SR.GetString(SRName.UIGalleryItemCategoryAllFontsText);

	/// <remarks>
	/// The value cannot be null, empty, or filled with white space.
	/// </remarks>
