...
public partial class MainWindow {
	...
	private ICommand? _closePromptCommand;
	...
	private async Task<UserPromptStandardResult> ShowPrompt(UserPromptControl userPromptControl) {
		...
		userPromptControl.Responding += (_, _) => {
			WindowChrome.SetIsOverlayVisible(this, false);
		};
	...
	/// <summary>
	/// The <see cref="ICommand"/> which is executed to close the overlay prompt without responding.
	/// </summary>
	public ICommand ClosePromptCommand
		=> _closePromptCommand ??= new DelegateCommand<object>(_ => ClosePrompt());
