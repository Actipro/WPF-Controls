...
public static class UserPromptBuilderExtensions {
	...
	public static UserPromptBuilder WithStatusImageTheme(this UserPromptBuilder builder, UserPromptStandardImage? statusImage = null) {
		...
		return builder.AfterBuild(_ => {
			...
			var colorFamilyName = statusImage switch {
				UserPromptStandardImage.Error => ColorFamilyName.Red,
				UserPromptStandardImage.Warning => ColorFamilyName.Orange,
				UserPromptStandardImage.Question => ColorFamilyName.Indigo,
				UserPromptStandardImage.Information or _ => ColorFamilyName.Blue,
			};
