...
public partial class MainControl {
	...
	public IEnumerable<double> MonthlyProduction
		=> [5, 6, 8, 8.5, 7.6, 7.4, 8.3, 9.5, 9.7, 8.3, 7.2, 11.3, 10.5, 10.4, 10.9, 11.3, 11.5, 11.7];

	/// <summary>
	/// The sales data.
	/// </summary>
	public IEnumerable<double> MonthlySales
		=> [3.7, 3.5, 3.8, 3.9, 4.1, 4.2, 4.4, 4.3, 4.5, 4.6, 4.6, 4.7];

	/// <summary>
	/// The sales data.
	/// </summary>
	public IEnumerable<double> PreviousMonthlySales
		=> [3.4, 3.3, 3.2, 3.6, 3.7, 3.8, 3.7, 3.7, 3.8, 3.9, 4.1, 4.0];
