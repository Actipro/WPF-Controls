...
public partial class SampleMvvmControl : SampleControlBase {
	...
	private BarGalleryViewModel CreateAdvancedPastOptionsGalleryViewModel() {
		return new BarGalleryViewModel("PasteOptions", PasteSpecialCommand, PasteOptions) {
			...
			CategoryHeaderTemplate = FindResource("PasteOptionGalleryCategoryTemplate") as DataTemplate,
			ItemTemplate = FindResource("PasteOptionGalleryItemTemplate") as DataTemplate,
		};
	}
	...
	private BarPopupButtonViewModel CreateShowcaseSampleAdvancedPasteOptionsViewModel() {
		return new BarPopupButtonViewModel("AdvancedPasteOptions") {
			...
			MenuItems = {
				...
				new BarButtonViewModel("PasteSpecial", "Paste Special...", "S", PasteSpecialCommand),
			},
		};
	}
	...
	private BarPopupButtonViewModel CreateShowcaseSampleViewOptionsWithColorTaggingViewModel() {
		var tagColorsGallery = new BarGalleryViewModel("TagColors", TagColors) {
			AreSurroundingSeparatorsAllowed = false,
			ItemSpacing = 6,
			...
			ItemContainerStyle = FindResource("CircularColorSwatchGalleryItemStyle") as Style,
		};
	...
	/// </summary>
	private static BarPopupButtonViewModel CreateTechnicalDemoInputGestureTextViewModel() {
