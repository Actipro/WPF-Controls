...
STEP SUMMARY:
	...
	Add new image registrations for Backstage tabs.

CHANGES SINCE LAST STEP:

	Registered images for BackstageTabHome and BackstageTabNew.
...
public class SampleBarManager {
	...
	private static ICommand? _notImplementedCommand;
	...
	private void RegisterControlViewModels() {
		...
		ControlViewModels.Register(SampleBarControlKeys.SelectAll, key
	...
	private void RegisterImages() {
		/*(New)*/ ImageProvider.Register(SampleBarControlKeys.BackstageTabHome, options => CreateBitmapImage(options, "HomeMono16.png", largeFileName: null));
		/*(New)*/ ImageProvider.Register(SampleBarControlKeys.BackstageTabNew, options => CreateBitmapImage(options, "New16.png", largeFileName: null));
		...
		ImageProvider.Register(SampleBarControlKeys.SelectAll, options => CreateBitmapImage(options, "SelectAll16.png", largeFileName: null));
