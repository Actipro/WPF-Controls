...
STEP SUMMARY:
	...
	Add keys for new Tabs displayed on the Backstage.

CHANGES SINCE LAST STEP:

	Added BackstageTabHome and BackstageTabNew keys.
...
namespace ActiproSoftware.ProductSamples.BarsSamples.QuickStart.GettingStarted.Step09 {
	...
	public class SampleBarControlKeys {
		...
		/// <summary>
		/// The key for the Close control displayed on the Backstage.
		/// </summary>
		public const string BackstageClose = nameof(BackstageClose);

		/// <summary>
		/// The key for the Help control displayed on the Backstage.
		/// </summary>
		public const string BackstageHelp = nameof(BackstageHelp);

		/// <summary>
		/// The key for the Print control displayed on the Backstage.
		/// </summary>
		public const string BackstagePrint = nameof(BackstagePrint);

		/// <summary>
		/// The key for the Home tab displayed on the Backstage.
		/// </summary>
		public const string BackstageTabHome = nameof(BackstageTabHome);

		/// <summary>
		/// The key for the New tab displayed on the Backstage.
		/// </summary>
		...
		/// <summary>
		/// The key for the Select All control.
		/// </summary>
