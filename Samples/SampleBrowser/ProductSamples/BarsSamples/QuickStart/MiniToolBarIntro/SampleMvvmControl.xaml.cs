...
public partial class SampleMvvmControl : UserControl {
	...
	/// by this sample.
	/// </summary>
	private static BarContextMenu CreateTextBoxContextMenu() {
		...
		var contextMenu = new BarContextMenu() {
			...
			Items = {
				...
				new BarButtonViewModel(ApplicationCommands.SelectAll) { SmallImageSource = ImageLoader.GetIcon("SelectAll16.png"), },
				new BarSeparatorViewModel(),
			...
			MiniToolBarContent = new MiniToolBarViewModel() {
				...
				Items = {
					...
					new BarButtonViewModel("Find", "Find", barManager.NotImplementedCommand) { SmallImageSource = ImageLoader.GetIcon("Find16.png"), },
				}
			}
		};
