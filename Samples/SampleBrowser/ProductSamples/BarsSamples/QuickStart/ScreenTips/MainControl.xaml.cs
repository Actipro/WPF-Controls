...
public partial class MainControl {
	...
	private void OnApplicationHelpExecute(object sender, ExecutedRoutedEventArgs e) {
		...
		MessageBox.Show("Show the default help topic here.", "Contextual Help", MessageBoxButton.OK, MessageBoxImage.Information);
	}
	...
	private static bool TryShowScreenTipContextualHelp(ScreenTip? screenTip) {
		if (screenTip?.Tag is ScreenTipData { Key: { } key } screenTipData) {
