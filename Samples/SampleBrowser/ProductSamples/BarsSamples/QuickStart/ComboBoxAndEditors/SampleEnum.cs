...
public enum SampleEnum {
	...
	//	Description	-> ToolTip
	//	GroupName	-> Category
	[Display(Order = 1, Name = "Display Item 1", Description = "Description of Display Item 1", GroupName = "Using DisplayAttribute")]
	DisplayItem1,

	[Display(Order = 3, Name = "Display Item 3", Description = "Description of Display Item 3", GroupName = "Using DisplayAttribute")]
	DisplayItem3, // NOTE: This item intentionally defined out of order to demonstrate the Order attribute property

	[Display(Order = 2, Name = "Display Item 2", Description = "Description of Display Item 2", GroupName = "Using DisplayAttribute")]
	DisplayItem2,
