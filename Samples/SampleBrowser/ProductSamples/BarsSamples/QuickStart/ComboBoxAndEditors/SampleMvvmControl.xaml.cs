...
public partial class SampleMvvmControl : SampleControlBase {
	...
	private BarTextBoxViewModel? _textBoxViewModel;
	...
	private void InitializeRibbonViewModels() {
		...
		// Textbox
		_textBoxViewModel = new BarTextBoxViewModel("Textbox") {
							...
							Items = {
								new RibbonControlGroupViewModel() {
									...
									Items = {
										...
										// Editable
										new BarComboBoxViewModel("Editable", ComboBoxGalleryCommand, ComboBoxPersonItems) {
											CanCategorize = false,
										...
										// Read-Only
										new BarComboBoxViewModel("ReadOnly", ComboBoxGalleryCommand, ComboBoxPersonItems) {
											CanCategorize = false,
										...
										// Non-Editable
										new BarComboBoxViewModel("NonEditable", "Non-Editable", ComboBoxGalleryCommand, ComboBoxPersonItems) {
											CanCategorize = false,
							...
							Items = {
								new RibbonControlGroupViewModel() {
									...
									Items = {
										...
										new BarComboBoxViewModel("CategorizedSingleColumn", "Single-Column", ComboBoxGalleryCommand, ComboBoxPersonItems) {
										...
										new BarComboBoxViewModel("CategorizedMultiColumn", "Multi-Column", ComboBoxGalleryCommand, ComboBoxNumberItems) {
										...
										new BarComboBoxViewModel("MenuStyle", ComboBoxGalleryCommand, ComboBoxColorItems) {
											CanFilter = true,
							...
							Items = {
								new RibbonControlGroupViewModel() {
									...
									Items = {
										...
										// Font family
										new BarComboBoxViewModel("FontFamily", ComboBoxGalleryCommand, ComboBoxFontFamilyItems) {
										...
										// Font size
										new BarComboBoxViewModel("FontSize", ComboBoxGalleryCommand, ComboBoxFontSizeItems) {
							...
							Items = {
								new RibbonControlGroupViewModel() {
									...
									Items = {
										...
										new BarComboBoxViewModel("EnumValue", ComboBoxGalleryCommand, ComboBoxEnumItems) {
