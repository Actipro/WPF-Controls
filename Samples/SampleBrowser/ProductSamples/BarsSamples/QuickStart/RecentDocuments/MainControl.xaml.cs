...
namespace ActiproSoftware.ProductSamples.BarsSamples.QuickStart.RecentDocuments {
	...
	public partial class MainControl {
		...
		private void OnOpenExecute(object sender, ExecutedRoutedEventArgs e) {
			...
			if (e.Parameter is IDocumentReference docReference) {
				// Make sure the application menu is closed after opening a recent document
