...
public static class FontSettings {
	...
	public static readonly FontFamily DefaultFontFamily = new(DefaultFontFamilyName);
	public static readonly FontFamily HeadingFontFamily = new(HeadingFontFamilyName);
