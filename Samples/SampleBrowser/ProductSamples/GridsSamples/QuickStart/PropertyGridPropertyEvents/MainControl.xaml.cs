...
public partial class MainControl {
	...
	public MainControl() {
		...
		var parent = new Person() { FirstName = "Preston", LastName = "Mansfield", Birthday = new DateTime(1940, 1, 30, 0, 0, 0) };

		var child = new Person() { FirstName = "Bob", LastName = "Mansfield", Birthday = new DateTime(1960, 9, 18, 0, 0, 0) };
	...
	/// <summary>
	/// Indicates whether property changes should be canceled.
	/// </summary>
