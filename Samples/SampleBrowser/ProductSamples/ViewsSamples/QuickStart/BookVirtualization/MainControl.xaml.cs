...
public partial class MainControl {
	...
	private static readonly string[] LoremIpsumStrings = {
	...
	private static TestObject GenerateItem(int index) {
	...
	private void OnSkipBackwardsButtonClick(object sender, RoutedEventArgs e)
		=> book.GoToPreviousPage(50);

	private void OnSkipForwardsButtonClick(object sender, RoutedEventArgs e)
		=> book.GoToNextPage(50);

	/// <summary>
	/// Updates the text block.
	/// </summary>
	private void UpdateTextBlock() {
		textBlock.Text = (book.ViewCount == 0)
			? "Generate pages above"
			: string.Format("{0} of {1}", book.SelectedViewIndex + 1, book.ViewCount);
	}
	...
	/// </summary>
	public DeferrableObservableCollection<TestObject> Pages { get; } = [];
