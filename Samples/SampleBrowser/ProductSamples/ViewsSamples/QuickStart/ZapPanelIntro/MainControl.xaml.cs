...
namespace ActiproSoftware.ProductSamples.ViewsSamples.QuickStart.ZapPanelIntro {
	...
	public partial class MainControl {
		...
		/// <summary>
		/// Identifies the <see cref="AreChildrenWrapped"/> dependency property.  This field is read-only.
		/// </summary>
		/// <value>The identifier for the <see cref="AreChildrenWrapped"/> dependency property.</value>
		public static readonly DependencyProperty AreChildrenWrappedProperty = DependencyProperty.Register("AreChildrenWrapped",
		...
		/// <summary>
		/// Gets or sets a value indicating whether the child items are wrapped around the item currently centered in the <see cref="ZapPanel"/>.
		/// This is a dependency property.
		/// </summary>
		/// <value>
		/// <c>true</c> if the child items are wrapped around the item currently centered in the <see cref="ZapPanel"/>; otherwise, <c>false</c>.
		/// The default value is <c>false</c>.
		/// </value>
		public bool AreChildrenWrapped {
			get { return (bool)this.GetValue(MainControl.AreChildrenWrappedProperty); }
			set { this.SetValue(MainControl.AreChildrenWrappedProperty, value); }
		}

		/// <summary>
		/// Gets or sets the orientation of the <see cref="ZapPanel"/>.
		/// This is a dependency property.
		/// </summary>
		/// <value>
