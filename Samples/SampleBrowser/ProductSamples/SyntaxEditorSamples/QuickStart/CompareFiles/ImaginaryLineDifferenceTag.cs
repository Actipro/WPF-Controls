...
public class ImaginaryLineDifferenceTag : IIntraLineSpacerTag {
	...
	/// <summary>
	/// The total margin that must be reserved for the imaginary lines.
	/// </summary>
	private ScreenUnits Margin
		=> LineCount * DefaultLineHeight;
	...
	public ScreenUnits BottomMargin
		=> IsBottomPosition ? Margin : default;

	/// <summary>
	/// The default height of a line.
	/// </summary>
	public ScreenUnits DefaultLineHeight { get; set; }

	/// <summary>
	/// Indicates if the tag should be aligned below the line or above the line.
	/// </summary>
	/// <value>
	...
	/// <summary>
	/// The number of imaginary lines represented by the tag.
	/// </summary>
	public int LineCount { get; set; }

	/// <inheritdoc cref="IIntraLineSpacerTag.TopMargin"/>
	public ScreenUnits TopMargin
		=> IsBottomPosition ? default : Margin;
