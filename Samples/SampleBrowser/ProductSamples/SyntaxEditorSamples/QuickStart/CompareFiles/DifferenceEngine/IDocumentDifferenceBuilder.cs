...
public interface IDocumentDifferenceBuilder {
	...
	/// <summary>
	/// The collection of differences in the latest document from the last compare operation.
	/// </summary>
	IDifferenceCollection? NewDifferences { get; }

	/// <summary>
	/// The collection of differences in the oldest document from the last compare operation.
	/// </summary>
