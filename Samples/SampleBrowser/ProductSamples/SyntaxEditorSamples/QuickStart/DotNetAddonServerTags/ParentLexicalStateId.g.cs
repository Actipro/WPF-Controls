namespace ActiproSoftware.ProductSamples.SyntaxEditorSamples.QuickStart.DotNetAddOnServerTags {
    ...
    /// <summary>
    /// Contains the lexical state IDs for the <c>Parent to C# example</c> language.
    /// </summary>
    /// <remarks>
    ...
    public partial class ParentLexicalStateId : LexicalStateIdProviderBase {
        ...
        /// <summary>
        /// Gets the <c>ChildCodeBlock</c> lexical state ID.
        /// </summary>
        public const Int32 ChildCodeBlock = 2;
        
        /// <summary>
        /// Gets the <c>ChildOutputBlock</c> lexical state ID.
        /// </summary>
