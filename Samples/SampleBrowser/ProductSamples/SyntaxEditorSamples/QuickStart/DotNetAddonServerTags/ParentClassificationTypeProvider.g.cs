                ...
                if ((this.keywordValue == null)) {
                    ...
                    if ((this.keywordValue == null)) {
                        ...
                        if ((darkColorPalette != null)) {
                            darkColorPalette.SetForeground(key, Color.FromArgb(255, 86, 156, 214));
                        }
            ...
            get {
                if ((this.transitionDelimiterValue == null)) {
                    ...
                    if ((this.transitionDelimiterValue == null)) {
                        IHighlightingStyleColorPalette darkColorPalette = this.registryValue.DarkColorPalette;
                        if ((darkColorPalette != null)) {
                            darkColorPalette.SetForeground(key, Color.FromArgb(255, 0, 0, 0));
                            darkColorPalette.SetBackground(key, Color.FromArgb(255, 239, 242, 132));
                        }
