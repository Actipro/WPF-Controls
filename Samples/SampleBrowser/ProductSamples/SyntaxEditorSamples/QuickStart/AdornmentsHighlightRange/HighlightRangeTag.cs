...
public class HighlightRangeTag : IClassificationTag {
	...
	private static readonly IClassificationType _highlightRangeClassificationType = new ClassificationType(HighlightRangeClassificationTypeKey, "Highlight Range");
	...
	static HighlightRangeTag() {
		...
		AmbientHighlightingStyleRegistry.Instance.Register(
			_highlightRangeClassificationType,
