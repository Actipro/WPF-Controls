...
using System;
using IActiproLoggerFatcory = ActiproSoftware.Products.Logging.ILoggerFactory;
using ActiproLoggerFatcory = ActiproSoftware.Products.Logging.LoggerFactory;
