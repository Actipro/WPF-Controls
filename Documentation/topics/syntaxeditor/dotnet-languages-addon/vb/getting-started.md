...
| ActiproSoftware.Text.Addons.DotNet.@@PlatformAssemblySuffix.dll | Yes | Actipro | .NET Languages Add-on | Core text/parsing for the Visual Basic language |
| ActiproSoftware.SyntaxEditor.Addons.DotNet.@@PlatformAssemblySuffix.dll | Yes | Actipro | .NET Languages Add-on | SyntaxEditor for @@PlatformName advanced Visual Basic syntax language implementation |
