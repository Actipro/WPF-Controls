...
The [VBIndentProvider](xref:ActiproSoftware.Text.Languages.VB.Implementation.VBIndentProvider) class is the default implementation of an [IIndentProvider](xref:ActiproSoftware.Windows.Controls.SyntaxEditor.IIndentProvider) service for this language.
