...
> [!IMPORTANT]
> Please make sure every docking window has either a unique [SerializationId](xref:@ActiproUIRoot.Controls.Docking.DockingWindow.SerializationId) or `Name` set as described above, or else layout deserialization will not work properly.
