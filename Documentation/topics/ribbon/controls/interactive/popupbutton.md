...
The [PopupButton](xref:@ActiproUIRoot.Controls.Ribbon.Controls.PopupButton) class provides an implementation of buttons that display a popup when clicked.
...
This is very useful if you want to have a control like a native WPF `TextBox` be resizable in a [PopupButton](xref:@ActiproUIRoot.Controls.Ribbon.Controls.PopupButton)'s popup.
