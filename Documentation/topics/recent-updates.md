...
- **Editors:** Added documentation for the new [DecimalEditBox](editors/editboxes/decimaleditbox.md) and [DecimalPicker](editors/pickers/decimalpicker.md) controls.
- **Editors:** Added documentation for the new [RangeSlider](xref:@ActiproUIRoot.Controls.Editors.RangeSlider) control.
