...
Note that [XYPercentageAxis](xref:ActiproSoftware.Windows.Controls.Charts.XYPercentageAxis) can only be used on numeric data. DateTime and complex types cannot be placed on the axis.
