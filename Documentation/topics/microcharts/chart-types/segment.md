...
It's easy to use the [MicroSegmentChart](xref:@ActiproUIRoot.Controls.MicroCharts.MicroSegmentChart) control.  Simply set its [Total](xref:@ActiproUIRoot.Controls.MicroCharts.MicroSegmentChart.Total) property to the total number of segments that should be displayed.  Then bind the [Value](xref:@ActiproUIRoot.Controls.MicroCharts.MicroSegmentChart.Value) property to a value indicating the number of segments that should be highlighted.  This value should be less than or equal to the total segment count.
...
The [MicroSegmentChart](xref:@ActiproUIRoot.Controls.MicroCharts.MicroSegmentChart) control can easily be customized to render segments in many interesting ways.
									...
									<VisualState x:Name="Highlighted">
										<Storyboard>
											<ObjectAnimationUsingKeyFrames Storyboard.TargetName="background" Storyboard.TargetProperty="Fill">
												<DiscreteObjectKeyFrame KeyTime="0" Value="{Binding RelativeSource={RelativeSource TemplatedParent}, Path=HighlightedBackground}" />
...
The [MicroSegmentChart](xref:@ActiproUIRoot.Controls.MicroCharts.MicroSegmentChart) control has two `ICommand` properties that can be bound to any button to allow incrementing or decrementing of the [Value](xref:@ActiproUIRoot.Controls.MicroCharts.MicroSegmentChart.Value) property.
