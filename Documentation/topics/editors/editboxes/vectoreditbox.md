...
Set the [IsNaNAllowed](xref:@ActiproUIRoot.Controls.Editors.VectorEditBox.IsNaNAllowed) property to `true` to allow a `NaN` value to be entered by typing the letter <kbd>N</kbd>.
